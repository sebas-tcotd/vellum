...
// The ramp-domain constants moved to `@vellum/core` so the export marginalia's
// elevation legend reads the same floor and anchors as the GPU ramp. Re-exported
// here so the adapter's relative imports keep working.
export {
  DEM_PAD_OFFSET,
  DEM_RAMP_FLOOR,
  demPadElevation,
...
import { demPadElevation } from '@vellum/core';
