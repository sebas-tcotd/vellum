...
| [Security and privacy](security-and-privacy.md)               | The CSP, the dependency audit, what an unsigned build means, and what network Vellum opens.      |
| [Packaging and installers](packaging-and-installers.md)       | What installer each platform publishes, what is customisable, and where the identity comes from. |
