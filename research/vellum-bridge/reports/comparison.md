...
| altavento-2026-09-23-pausa | comparison-complete | snapshots/snapshot-20260923T024603927Z.json | cslmap/Altavento-20260922-214600.cslmap |
| island-hopping-2026-09-23-pausa | comparison-complete | snapshots/snapshot-20260923T032332376Z.json | cslmap/Island Hopping-20260922-221408.cslmap |
| san-rico-2026-09-23-pausa | comparison-complete | snapshots/snapshot-20260923T035548388Z.json | cslmap/san-rico-20260922-225502.cslmap |
| westdale-2026-09-23-pausa | comparison-complete | snapshots/snapshot-20260923T035903373Z.json | cslmap/westdale-20260922-225858.cslmap |
| costa-tijuca-2026-09-23-pausa | comparison-complete | snapshots/snapshot-20260923T060240938Z.json | cslmap/costa-tijuca-20260923-010237.cslmap |

Las categorías estructurales no implican equivalencia semántica. `unresolved` requiere revisión humana.

## Resumen del corpus

Pares: 15 (15 capturas parciales)

| Dominio | Ciudades con raw | Ciudades con .cslmap | Conteo raw (mín–máx) |
|---|---:|---:|---|
| roads | 15 | 15 | 2658–31430 |
| transit | 15 | 15 | 0–113 |
| buildings | 15 | 15 | 1551–46888 |
| districts | 15 | 15 | 1–90 |
| vegetation | 15 | 15 | 541–262143 |
| parks | 15 | 15 | 0–17 |
| terrain | 15 | 15 | — |
| water | 5 | 15 | — |

Tránsito (líneas con paradas): 497 líneas, 497 en .cslmap, 495 con la ruta .cslmap contenida en el camino crudo (excepciones: altavento-2026-09-22#103, springvalley-2026-09-22#250); 6 tramos sin camino.
Paradas sobre calle con nombre: 4724 de 6369 (74 %).
Nombre de línea igual en .cslmap (GetLineName): 497 de 497; color igual: 125.
Etiquetas .cslmap de districts dentro de su área raw: 367 de 382.
Etiquetas .cslmap de parks dentro de su área raw: 72 de 72.
...
## altavento-2026-09-23-pausa

Captura: parcial
Dominios no soportados: dlcs, mods
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| 1168561 | 367099 | 367099 | 367099 | 1 | 1168561 | 366865 | 187 | 187.031 | 192.016, 194.031, 195.563, 195.656, 198.969, 210.328, 216.734, 218.594 | 1: 8, 2: 8 |
...
|---:|---|---:|---:|---:|---:|---:|---:|---|---|---:|---:|
| 3 | Bus Line 2 | 16 | 16 | 16 | 0 | 84 | 68 | no | sí | 1 | 0 |
| 103 | Bus Line 1 | 20 | 20 | 20 | 0 | 290 | 270 | no | sí | 1 | 0 |
| 173 | Tram Line 1 | 15 | 15 | 15 | 0 | 160 | 145 | no | sí | 1 | 0 |
| 220 | Bus Line 0 | 0 | 0 | 0 | 0 | 0 | 0 | sí | sí | 1 | 0 |
...
## island-hopping-2026-09-23-pausa
...
| Celdas | Mojadas raw | Mojadas .cslmap | Ambas | Jaccard | Terreno idéntico | res = profundidad | Cota modal raw (m) | SeaLevel .cslmap | Targets naturales (m) | Fuentes por tipo |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| 1168561 | 873861 | 873861 | 873861 | 1 | 1167748 | 873678 | 160 | 160.140625 | — | 2: 43 |

### Capas de alturas

Celdas donde <Ter> difiere de RawHeights: 813

| Capa | Celdas distintas de RawHeights | Diferencias de <Ter> que explica |
|---|---:|---:|
| RawHeights2 | 813 | 813 |
| BlockHeights | 36927 | 667 |
...
| Celdas | Mojadas raw | Mojadas .cslmap | Ambas | Jaccard | Terreno idéntico | res = profundidad | Cota modal raw (m) | SeaLevel .cslmap | Targets naturales (m) | Fuentes por tipo |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| 1168561 | 713842 | 713842 | 713842 | 1 | 1168527 | 713250 | 56 | 56.3430023 | 49.984, 128.891, 132.375, 148.984 | 1: 4, 2: 23 |

### Vegetación

| Celdas | Con bosque en .cslmap | = m_forest | = m_tree | = densidad de árboles raw | Árboles | Buffer de árboles |
|---:|---:|---:|---:|---:|---:|---:|
| 262144 | 54534 | 234525 | 262144 | 222813 | 262143 | 262144 |

### Capas de alturas

Celdas donde <Ter> difiere de RawHeights: 34

| Capa | Celdas distintas de RawHeights | Diferencias de <Ter> que explica |
|---|---:|---:|
| RawHeights2 | 34 | 34 |
| BlockHeights | 196678 | 29 |
...
| Celdas | Mojadas raw | Mojadas .cslmap | Ambas | Jaccard | Terreno idéntico | res = profundidad | Cota modal raw (m) | SeaLevel .cslmap | Targets naturales (m) | Fuentes por tipo |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| 1168561 | 516190 | 516190 | 516190 | 1 | 1168239 | 516157 | 10 | 9.779 | 14.422, 16.922, 20.797 | 1: 3 |

### Vegetación

| Celdas | Con bosque en .cslmap | = m_forest | = m_tree | = densidad de árboles raw | Árboles | Buffer de árboles |
|---:|---:|---:|---:|---:|---:|---:|
| 262144 | 61760 | 262099 | 262144 | 200493 | 541 | 262144 |

### Capas de alturas

Celdas donde <Ter> difiere de RawHeights: 322

| Capa | Celdas distintas de RawHeights | Diferencias de <Ter> que explica |
|---|---:|---:|
| RawHeights2 | 322 | 322 |
| BlockHeights | 171071 | 157 |
...
| Celdas | Mojadas raw | Mojadas .cslmap | Ambas | Jaccard | Terreno idéntico | res = profundidad | Cota modal raw (m) | SeaLevel .cslmap | Targets naturales (m) | Fuentes por tipo |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| 1168561 | 444855 | 444855 | 444855 | 1 | 1167986 | 444819 | 40 | 40 | 41.313, 46.344, 197.75, 326.391 | 1: 4 |

### Vegetación

| Celdas | Con bosque en .cslmap | = m_forest | = m_tree | = densidad de árboles raw | Árboles | Buffer de árboles |
|---:|---:|---:|---:|---:|---:|---:|
| 262144 | 47118 | 252870 | 262144 | 251760 | 115259 | 262144 |

### Capas de alturas

Celdas donde <Ter> difiere de RawHeights: 575

| Capa | Celdas distintas de RawHeights | Diferencias de <Ter> que explica |
|---|---:|---:|
| RawHeights2 | 575 | 575 |
| BlockHeights | 153153 | 540 |
